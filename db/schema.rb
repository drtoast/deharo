...
ActiveRecord::Schema.define(version: 20131127183026) do
  ...
  create_table "transaction_presets", force: true do |t|
    t.integer  "transaction_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "transaction_presets", ["transaction_id"], name: "index_transaction_presets_on_transaction_id", using: :btree
